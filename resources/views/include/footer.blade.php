            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    <div class="copyright">
                        21 May 2025, made with <i class="fa fa-heart heart text-danger"></i> by
                        <a target="_blank" href="https://facebook.com/420rahat2">Md. Rahat Ahmed</a>
                    </div>
                    <div>
                        Distributed by
                        <a target="_blank" href="https://elitbuzz-bd.com/">Elitbuzz-BD</a>.
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script src="user/assets/js/setting-demo.js"></script>
    ...
    <script src="user/assets/js/kaiadmin.min.js"></script>
    <!-- Kaiadmin DEMO methods, don't include it in your project! -->
    <script src="user/assets/js/setting-demo2.js"></script>
    <script>
